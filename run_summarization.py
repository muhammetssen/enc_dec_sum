...
def main():
    ...
    print("Model arguements: {}".format(model_args))
    print("Data arguements: {}".format(data_args))
    print("Training arguements: {}".format(training_args))
    ...
    if "mbart" in model_args.model_name_or_path:
        tokenizer = MBartTokenizerFast.from_pretrained(
            model_args.tokenizer_name if model_args.tokenizer_name else model_args.model_name_or_path, src_lang="tr_TR",
            tgt_lang="tr_TR")
    else:
