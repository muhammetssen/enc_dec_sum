...
--text_outputs_file_path $HOME_DIR/rouge_test_mt5_title/text_outputs_gpu_stemmed.csv \
--rouge_outputs_file_path $HOME_DIR/rouge_test_mt5_title/rouge_outputs_gpu_stemmed.json \
--novelty_outputs_file_path $HOME_DIR/rouge_test_mt5_title/novely_outputs_gpu_stemmed.json \
