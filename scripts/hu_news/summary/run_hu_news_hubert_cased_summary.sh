...
RUN_NAME=hu_news_hubert_cased_summary
...
--train_file /truba/home/bbaykara/code/enc_dec_sum/data/hu_news_raw/train.csv \
--validation_file /truba/home/bbaykara/code/enc_dec_sum/data/hu_news_raw/validation.csv \
--test_file /truba/home/bbaykara/code/enc_dec_sum/data/hu_news_raw/test.csv \
