...
RUN_NAME=ml_sum_berturk32k_cased_title_first3
...
--train_file $HOME_DIR/data/ml_sum_tr_raw/train.csv \
--validation_file $HOME_DIR/data/ml_sum_tr_raw/validation.csv \
--test_file $HOME_DIR/data/ml_sum_tr_raw/test.csv \
